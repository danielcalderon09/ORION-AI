...
class ArtifactType(StrEnum):
    ...
    PRODUCTION_SHOT_EXPANSION = "production_shot_expansion"
    PRODUCTION_VISUAL_ASSET_PLAN = "production_visual_asset_plan"
    HYBRID_VISUAL_STRATEGY_PLAN = "hybrid_visual_strategy_plan"
    AGGREGATE_VISUAL_BUDGET_PLAN = "aggregate_visual_budget_plan"
    PRODUCTION_IMAGE_ACQUISITION_MANIFEST = "production_image_acquisition_manifest"
    HYBRID_ASSET_ACQUISITION_MANIFEST = "hybrid_asset_acquisition_manifest"
    PRODUCTION_VIDEO_CLIP_MANIFEST = "production_video_clip_manifest"
    HYBRID_VIDEO_GENERATION_MANIFEST = "hybrid_video_generation_manifest"
    HYBRID_IMAGE_MOTION_COMPOSITION_PLAN = "hybrid_image_motion_composition_plan"
    HYBRID_FFMPEG_EXECUTION_PLAN = "hybrid_ffmpeg_execution_plan"
    HYBRID_IMAGE_MOTION_RENDER_RESULT = "hybrid_image_motion_render_result"
