...
def local_mvp_settings() -> Settings:
    ...
    return Settings(
        ...
        ORION_VISUAL_STRATEGY=discovered.ORION_VISUAL_STRATEGY,
        ORION_HYBRID_IMAGE_ESTIMATED_COST_USD=(
            discovered.ORION_HYBRID_IMAGE_ESTIMATED_COST_USD
        ),
        ORION_HYBRID_VIDEO_PRICE_PER_SECOND_USD=(
            discovered.ORION_HYBRID_VIDEO_PRICE_PER_SECOND_USD
        ),
        ORION_MAX_TOTAL_VISUAL_COST_USD=discovered.ORION_MAX_TOTAL_VISUAL_COST_USD,
        ORION_IMAGE_ONLY_MAX_REQUESTS_PER_JOB=(
            discovered.ORION_IMAGE_ONLY_MAX_REQUESTS_PER_JOB
        ),
        ORION_IMAGE_ONLY_MAX_ESTIMATED_COST_USD=(
            discovered.ORION_IMAGE_ONLY_MAX_ESTIMATED_COST_USD
        ),
        ...
        ORION_NARRATION_FITTING_MAX_PROVIDER_RETRIES=(
            discovered.ORION_NARRATION_FITTING_MAX_PROVIDER_RETRIES
        ),
